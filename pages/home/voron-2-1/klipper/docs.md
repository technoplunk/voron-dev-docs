...
First you should check that the toolhead can actually reach the switches without interferance. Use the set_kinematcis command and slowly jog the toolhead to the right and confirm that you can hear the X endstop switch clicks at X-Max. 
